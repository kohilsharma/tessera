...
`/search` (#32) — are done, as is the Record archetype on Story and Article detail (#33);
Brief detail, the form pages, and the dashboards are still plain markup
awaiting their archetype (#34–#37). `/` redirects to the caller's own dashboard. The
